...
export const trainingScenarios = [
  ...
  { id: 10, scenario: "A 40-year-old man calls saying his left calf has been swollen and painful for 2 days. He had knee surgery 3 weeks ago.", correctAnswer: 'gp-triager-urgent', explanation: 'Unilateral calf swelling + recent surgery = suspected DVT (NICE NG158). AMBER flag — SDEC via A&E for same-day assessment. Do NOT use self-care.', options: [{ id: '999', text: 'Call 999' }, { id: 'gp-triager-urgent', text: 'SDEC via A&E (URGENT same-day)' }, { id: 'pharmacy-first', text: 'Pharmacy First' }, { id: 'calmcare', text: 'CalmCare self-care' }] },
  ...
  { id: 20, scenario: "Patient: 'I can't pee at all and my stomach is really painful and swollen.'", correctAnswer: '999', explanation: "Cannot pass urine + severe abdominal pain = acute urinary retention. This is a RED flag. Call 999 / advise A&E now.", options: [{ id: '999', text: 'Call 999' }, { id: 'gp-sameday', text: 'Book same-day GP' }, { id: 'gp-triager', text: 'Send to GP Triager' }, { id: 'drink-water', text: 'Advise drink more water' }] },
  { id: 21, scenario: "Patient: 'I had an eConsult about my eczema last month, they gave me a cream but it's not working and the rash is spreading.'", correctAnswer: 'book-f2f', explanation: 'Tried and failed rule — condition already managed via eConsult and treatment did not work. Book face-to-face GP, NOT another eConsult.', options: [{ id: 'econsult', text: 'Submit another eConsult' }, { id: 'book-f2f', text: 'Book face-to-face GP' }, { id: 'pharmacy-first', text: 'Pharmacy First' }, { id: 'calmcare', text: 'CalmCare eczema card' }] },
  { id: 22, scenario: "Patient: 'I've been having bad headaches and I think it's my blood pressure tablets. Can I just stop taking them?'", correctAnswer: 'gp-triager', explanation: 'ALL medication decisions = PURPLE = Tier 3. Dose changes, side effects, stopping medication — always GP Triager.', options: [{ id: 'pharmacy-first', text: 'Pharmacy First' }, { id: 'gp-triager', text: 'Tier 3 GP Triager' }, { id: 'calmcare', text: 'CalmCare headache card' }, { id: 'stop-meds', text: 'Advise to stop tablets' }] },
  { id: 23, scenario: "Patient: 'My baby is 4 months old and I'm worried she's not feeding properly.'", correctAnswer: 'health-visiting', explanation: 'Child 0-5, feeding concern = Health Visiting pathway. Call 020 8339 8000. Well Baby Clinics Tue/Wed/Thu.', options: [{ id: 'gp-triager', text: 'Send to GP Triager' }, { id: 'health-visiting', text: 'Health Visiting Service' }, { id: 'pharmacy-first', text: 'Pharmacy First' }, { id: '999', text: 'Call 999' }] },
  { id: 24, scenario: "Patient: 'I've got a few things — my knee hurts, I've been getting headaches, and I'm just really tired all the time.'", correctAnswer: 'gp-triager', explanation: "Multiple overlapping symptoms = PURPLE. Doesn't cleanly match ONE category. Tier 2 cannot process — escalate to Tier 3.", options: [{ id: 'pharmacy-first', text: 'Pharmacy First' }, { id: 'gp-triager', text: 'Tier 3 GP Triager' }, { id: 'calmcare', text: 'CalmCare fatigue card' }, { id: 'book-routine', text: 'Book routine GP' }] },
  { id: 25, scenario: "Patient: 'I've had acne for ages. The GP did an eConsult and gave me some cream but it hasn't helped at all.'", correctAnswer: 'book-f2f', explanation: 'Green flag (acne) but eConsult treatment already tried and failed. Book face-to-face within 1 week.', options: [{ id: 'econsult', text: 'Submit another eConsult' }, { id: 'book-f2f', text: 'Book face-to-face GP (1 week)' }, { id: 'pharmacy-first', text: 'Pharmacy First' }, { id: 'calmcare', text: 'CalmCare acne card' }] },
  { id: 26, scenario: "Patient: 'I'm 70 and I think I've got a water infection. Burning when I go.'", correctAnswer: 'book-gp', explanation: 'UTI but patient >64 = NOT Pharmacy First eligible. Yellow flag — book GP within 1-3 days. If blood/fever/back pain → amber same-day.', options: [{ id: 'pharmacy-first', text: 'Pharmacy First' }, { id: 'book-gp', text: 'Book GP 1-3 days' }, { id: 'calmcare', text: 'CalmCare UTI card' }, { id: '999', text: 'Call 999' }] },
  { id: 27, scenario: "Patient: 'My 8-month-old has been really grizzly and pulling at her ear.'", correctAnswer: 'gp-triager', explanation: 'Under 1 year = ANY new concern is PURPLE. Must escalate to Tier 3. Never Pharmacy First or self-care for under 1s.', options: [{ id: 'pharmacy-first', text: 'Pharmacy First (Earache)' }, { id: 'gp-triager', text: 'Tier 3 GP Triager' }, { id: 'healthier-together', text: 'Healthier Together' }, { id: 'calmcare', text: 'CalmCare earache' }] }
];
...
export const tier2Actions = {
  ...
  timeLimits: {
    amber: 'within 1 hour',
    yellow: 'within 2 hours',
    green: 'within 2 hours',
    endOfDay: 'auto-escalate'
  }
};
...
export const trainingTopics = {
  ...
  'Pharmacy First & Self-Care': [5, 6, 18, 26],
  'High-Risk Patients': [2, 8, 19],
  'Pathways & Signposting': [9, 10, 17, 23],
  'Amber Flags & GP Triager': [7, 16],
  'Patient Declines': [11],
  'Purple Flags & Mandatory Escalation': [22, 24, 27],
  'eConsult & Tried-and-Failed': [21, 25],
  'Health Visiting & Children 0-5': [2, 23, 27]
};
