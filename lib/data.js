...
// Matching SOP Section 9B. Schema: { category: string, buzzwords: string, keywords: string[], action: string, notes: string }
export const amberFlags = [
  {
    category: 'Breathing / Cough',
    buzzwords: 'New/worsening breathlessness, wheeze, asthma/COPD flare, coughing blood, fever + chest pain',
    keywords: [
      'worsening breathlessness', 'new breathlessness', 'wheeze', 'asthma flare', 'asthma attack',
      'COPD flare', 'coughing blood', 'fever chest pain', 'breathing getting worse',
      'more breathless than usual', 'inhaler not working', 'chest tight wheeze',
      'short of breath new', 'puffer not helping', 'asthma worse'
    ],
  ...
  },
  {
    ...
    buzzwords: "Severe persistent pain, can't keep fluids, persistent vomiting, severe diarrhoea, diabetes + vomiting",
    keywords: [
      'severe persistent pain', 'can\'t keep fluids down', 'dehydrated', 'not drinking',
      'persistent vomiting', 'severe diarrhoea', 'diabetes vomiting', 'can\'t keep water down',
      'been sick all day', 'diarrhoea won\'t stop', 'not eaten days', 'tummy pain won\'t go',
      'stomach cramps severe', 'vomiting for days', 'can\'t keep anything down'
    ],
    action: 'Same-day duty GP',
    notes: ''
  },
  {
    ...
    buzzwords: 'BM <4 or >20, shaking/sweating/confusion, fruity breath, persistent vomiting, Type 1 unwell',
    keywords: [
      'blood sugar low', 'blood sugar under 4', 'blood sugar over 20', 'blood sugar high',
      'hypo', 'shaking sweating', 'fruity breath', 'very thirsty urinating', 'type 1 unwell',
      'diabetes vomiting', 'sugar reading low', 'sugar reading high', 'BM low', 'BM high',
      'diabetic feeling unwell', 'insulin not working', 'blood sugar won\'t come down',
      'hyper', 'diabetic ketoacidosis', 'DKA'
    ],
    action: 'Same-day duty GP',
    notes: ''
  },
  {
    category: 'Urinary',
    buzzwords: 'Blood in urine, flank/back pain + fever, male urinary symptoms, catheter problem, pregnancy + UTI symptoms',
    keywords: [
      'blood in urine', 'flank pain fever', 'back pain fever', 'male UTI', 'male urinary',
      'catheter problem', 'pregnant UTI', 'can\'t pass urine', 'bladder won\'t empty',
      'blood in wee', 'peeing blood', 'kidney pain fever', 'man urinary infection',
      'catheter blocked', 'catheter leaking', 'pregnant burning pee', 'urine dark blood',
      'stinging urine male', 'difficulty peeing man'
    ],
    action: 'Same-day duty GP. NOT Pharmacy First.',
    notes: 'NOT Pharmacy First for male UTI, pregnant UTI, catheter issues, or blood in urine.'
  },
  {
    category: 'Neurology / Headache',
    buzzwords: 'Sudden severe headache, new weakness/numbness, new confusion, blackout/fainting. If stroke signs \u2192 999',
    keywords: [
      'sudden severe headache', 'new weakness', 'new numbness', 'new confusion',
      'blackout', 'fainted', 'loss of consciousness', 'dizzy and weak',
      'numb arm new', 'numb leg new', 'can\'t think straight', 'keep fainting',
      'passed out', 'collapsed and came round', 'vision gone funny', 'seeing double new'
    ],
    action: 'Same-day duty GP. Stroke signs \u2192 999.',
    notes: 'If stroke signs (FAST) \u2192 call 999 immediately, do not wait for GP.'
  },
  {
    category: 'Skin / Infection',
    buzzwords: 'Rapidly spreading redness, face/eye involvement, rigors, very unwell, tracking redness',
    keywords: [
      'rapidly spreading redness', 'cellulitis spreading', 'face infection', 'eye infection',
      'rigors', 'shivering', 'very unwell', 'tracking redness', 'red line spreading',
      'skin spreading red', 'wound gone red spreading', 'hot swollen red skin',
      'face swelling infection', 'redness getting bigger', 'infection spreading fast'
    ],
    action: 'Same-day duty GP',
    notes: ''
  },
  {
    ...
    buzzwords: 'Painful red eye, sudden loss of vision, flashes/floaters, injury/chemical splash',
    keywords: [
      'painful red eye', 'sudden vision loss', 'flashes in vision', 'floaters new',
      'eye injury', 'chemical splash', 'red eye painful', 'can\'t see out of eye',
      'eye suddenly blurry', 'flashing lights eye', 'spots in vision new',
      'shingles near eye', 'contact lens pain', 'eye swollen shut', 'light hurts eye'
    ],
    action: 'CUES / Royal Eye Unit. If severe \u2192 999/A&E',
    notes: 'Most eye problems \u2192 CUES via optician. Urgent \u2192 Royal Eye Unit: 020 8934 6799. Chemical splash / acute glaucoma \u2192 999.'
  },
  {
    category: 'DVT (NICE NG158)',
    buzzwords: 'Unilateral calf/leg swelling, red/hot leg, post-surgery/flight',
    keywords: [
      'swollen leg one side', 'calf swelling', 'red hot leg', 'leg swollen after surgery',
      'leg swollen after flight', 'one leg bigger', 'calf pain swelling',
      'leg swollen one side', 'calf red hot', 'leg puffy after operation',
      'leg swollen after long journey', 'one calf bigger', 'dvt', 'blood clot leg',
      'leg swollen and painful', 'calf hard and swollen', 'leg swollen immobile'
    ],
    action: 'URGENT same-day (Wells score assessment needed)',
    notes: 'NICE NG158. Higher risk post-surgery, immobility, long-haul flight, cancer, pregnancy, HRT/OCP.'
  },
  {
    category: 'PE (NICE NG158)',
    buzzwords: 'Sharp chest pain breathing, breathless + chest pain, post-surgery/flight',
    keywords: [
      'breathless chest pain', 'sharp chest pain breathing', 'coughing blood breathless',
      'chest pain after surgery', 'chest pain after flight', 'pleuritic chest pain',
      'chest pain when breathe in', 'chest pain deep breath', 'short of breath chest pain',
      'breathless after operation', 'breathless after travel', 'stabbing chest pain breathing',
      'chest pain worse breathing', 'pe', 'pulmonary embolism'
    ],
    action: 'URGENT same-day. If severe breathlessness/collapse \u2192 999',
    notes: 'NICE NG158. If severe breathlessness or collapse \u2192 call 999 immediately.'
  },
  {
    category: 'Temporal Arteritis / GCA',
    buzzwords: 'Headache in >50 + jaw pain chewing + scalp tenderness + vision changes',
    keywords: [
      'headache over 50', 'jaw pain chewing', 'scalp tender', 'temple headache',
      'vision blurry headache', 'temporal headache new', 'jaw aches eating',
      'scalp sore to touch', 'headache one side temple', 'new headache elderly',
      'vision problems headache', 'jaw claudication', 'headache and can\'t see properly',
      'temple pain new', 'head sore to brush hair'
    ],
    action: 'URGENT same-day. Risk of permanent vision loss.',
    notes: 'NICE NG244; BSR GCA Guidelines. Delay risks irreversible blindness — treat as urgent.'
  },
  {
    category: 'Renal Colic / Kidney Stone',
    buzzwords: "Loin-to-groin pain, severe side pain, writhing/can't lie still",
    keywords: [
      'loin to groin pain', 'severe side pain', 'can\'t lie still pain', 'kidney pain severe',
      'renal colic', 'writhing pain', 'pain in side going to groin', 'rolling around in pain',
      'kidney stone', 'back pain shooting to groin', 'worst side pain',
      'can\'t get comfortable pain', 'pain loin area', 'flank pain severe'
    ],
    action: 'Same-day duty GP',
    notes: ''
  },
  {
    category: 'Fever in Under 5s (NICE NG143)',
    buzzwords: 'Baby/toddler high temp, floppy, not feeding. Non-blanching rash \u2192 999',
    keywords: [
      'baby fever', 'toddler high temperature', 'child hot floppy', 'baby not feeding fever',
      'child fever rash', 'baby temperature', 'toddler burning up', 'child won\'t eat fever',
      'baby hot and floppy', 'child shivering fever', 'baby over 38', 'child temperature high',
      'toddler fever won\'t come down', 'baby feels hot', 'infant fever'
    ],
    action: 'Same-day duty GP (NICE traffic light assessment). Non-blanching rash \u2192 999',
    notes: 'NICE NG143. Non-blanching rash in child \u2192 999 immediately (see RED flags).'
  },
  {
    category: 'Neutropenic Sepsis (NICE NG151)',
    buzzwords: 'Chemo/transplant + ANY fever or feeling unwell',
    keywords: [
      'chemo fever', 'chemotherapy temperature', 'cancer treatment fever',
      'immunosuppressed fever', 'transplant fever', 'chemo and unwell',
      'cancer treatment shivering', 'chemo patient temperature', 'on chemo feeling awful',
      'chemo and shaking', 'cancer treatment and sick', 'biologic fever',
      'immunosuppressed and unwell', 'chemo rigors', 'after chemo fever'
    ],
    action: 'URGENT \u2192 may need 999/A&E. Do NOT use Pharmacy First.',
    notes: 'NICE NG151. ANY fever in chemo/immunosuppressed patient = potential neutropenic sepsis. Never Pharmacy First.'
  },
  {
    category: 'Testicular Pain',
    buzzwords: 'Sore/swollen testicle, acute scrotal pain. Sudden + vomiting \u2192 999',
    keywords: [
      'testicle pain', 'testicular pain', 'sore testicle', 'swollen testicle', 'balls aching',
      'scrotal pain', 'testicle swollen', 'balls sore', 'one testicle bigger',
      'testicle lump', 'pain in scrotum', 'groin ache testicle', 'tender testicle',
      'ball pain', 'testicle hurts'
    ],
    action: 'Same-day duty GP. Sudden onset + vomiting \u2192 999 (see RED flags)',
    notes: 'Sudden severe pain + vomiting = possible torsion \u2192 call 999.'
  },
  {
    category: "Women's Health / Pregnancy",
    buzzwords: "Pregnancy <18wks + pain/bleeding, reduced movements (18+), postnatal bleeding/headache",
    keywords: [
      'pregnant pain', 'pregnant bleeding', 'pregnant can\'t keep fluids', 'early pregnancy pain',
      'pregnant vomiting', 'reduced movements', 'baby not moving', 'waters breaking',
      'contractions', 'pregnant headache', 'pregnant vision',
      'bleeding early pregnancy', 'morning sickness severe', 'postnatal bleeding',
      'postnatal headache', 'postnatal breathless', 'pregnant and unwell'
    ],
    action: 'Same-day or maternity triage. >18wks: Maternity Helpline 0208 934 2802. If severe: 999.',
    notes: 'If <12wks + one-sided pain + shoulder tip \u2192 999 (ectopic). >18wks \u2192 Maternity Helpline.'
  },
  {
    category: 'Possible Cancer (NICE NG12)',
    buzzwords: 'New lump, unexplained weight loss/bleeding, bowel change >6wks, swallowing difficulty, PMB, voice hoarseness >3wks, night sweats, non-healing ulcer, mole changes, persistent bloating (women >50)',
    keywords: [
      'new lump', 'breast lump', 'unexplained weight loss', 'unexplained bleeding',
      'change bowels 6 weeks', 'difficulty swallowing', 'blood urine',
      'postmenopausal bleeding', 'hoarse voice 3 weeks', 'night sweats',
      'persistent cough 3 weeks', 'persistent rectal bleeding', 'blood in poo',
      'non-healing ulcer', 'sore won\'t heal', 'mole changed', 'unexplained fatigue',
      'iron deficiency', 'persistent bloating', 'nipple discharge', 'breast skin changes',
      'nipple changes', 'persistent lymph node', 'swollen glands 3 weeks',
      'unexplained bone pain', 'unexplained fracture', 'mouth ulcer won\'t heal',
      'lump in neck', 'lump in groin', 'lump armpit', 'losing weight no reason',
      'bleeding after menopause', 'food getting stuck'
    ],
    action: 'ESCALATE TIER 3 (2WW referral pathway). Do NOT book routine.',
    notes: 'NICE NG12. Always Tier 3 — GP must decide 2WW referral. Never book routine without clinician review.'
  },
  {
    category: 'Safeguarding',
    buzzwords: 'Domestic abuse, sexual assault, child/adult safeguarding concern/alert',
    keywords: [
      'domestic abuse', 'sexual assault', 'child concern', 'adult safeguarding',
      'neglect', 'vulnerable', 'domestic violence', 'being hurt at home',
      'partner hitting', 'child at risk', 'afraid of partner', 'forced',
      'trafficking', 'controlling behaviour', 'elder abuse'
    ],
    action: 'ESCALATE TIER 3 + duty clinician. Follow safeguarding policy.',
    notes: 'Always Tier 3. Follow local safeguarding policy immediately.'
  },
  {
    category: 'Mental Health',
    buzzwords: 'Suicidal with plan, self-harm with intent, psychotic, acute agitation',
    keywords: [
      'suicidal thoughts plan', 'going to harm', 'recent self-harm intent',
      'hearing voices harm', 'severe agitation', 'psychotic', 'suicidal with plan',
      'planning to end it', 'self-harm with intent', 'voices telling to harm',
      'paranoid and agitated', 'manic episode', 'detached from reality',
      'not sleeping days psychosis', 'threatening harm to self'
    ],
    action: 'ESCALATE TIER 3 + Crisis Line: 0800 028 8000 (CAMHS <18: 0203 228 5980)',
    notes: 'Always Tier 3. Crisis Line: 0800 028 8000 (adults) / 0203 228 5980 (under 18).'
  }
];

// Matching SOP Section 10. Schema: { group: string, keywords: string[], action: string }
export const highRiskGroups = [
  {
    group: 'Pregnant or postnatal (up to 6 weeks after birth)',
    keywords: [
      'pregnant', 'pregnancy', 'postnatal', 'post-natal', 'just had baby',
      'recently gave birth', 'weeks after birth', 'breastfeeding and unwell',
      'expecting', 'maternity'
    ],
    action: 'Forward to Tier 2 with HIGH RISK flag. Do NOT use self-care or Pharmacy First.'
  },
  {
    group: 'Weakened immune system (chemo, transplant, biologics, steroids, HIV)',
    keywords: [
      'chemotherapy', 'chemo', 'transplant', 'biologic', 'immunosuppressed',
      'steroids long term', 'HIV', 'on methotrexate', 'on azathioprine',
      'on ciclosporin', 'cancer treatment', 'immune system', 'radiotherapy'
    ],
    action: 'Forward to Tier 2 with HIGH RISK flag. Do NOT use self-care or Pharmacy First.'
  },
  {
    ...
    keywords: [
      'no spleen', 'splenectomy', 'sickle cell', 'spleen removed',
      'asplenic', 'sickle disease'
    ],
    action: 'Forward to Tier 2 with HIGH RISK flag. Do NOT use self-care or Pharmacy First.'
  },
  {
    ...
    keywords: [
      'care home', 'nursing home', 'residential home', 'frail', 'housebound',
      'elderly confused', 'very elderly', 'sheltered housing', 'warden assisted',
      'bed bound', 'immobile elderly'
    ],
    action: 'Forward to Tier 2 with HIGH RISK flag. Do NOT use self-care or Pharmacy First.'
  },
  {
    group: 'Severe chronic conditions (asthma/COPD, heart failure, kidney disease, diabetes, liver disease)',
    keywords: [
      'severe asthma', 'COPD', 'heart failure', 'kidney disease', 'liver disease',
      'diabetes', 'diabetic', 'type 1', 'type 2', 'on insulin', 'dialysis',
      'oxygen at home', 'home oxygen', 'chronic lung'
    ],
    action: 'Forward to Tier 2 with HIGH RISK flag. Do NOT use self-care or Pharmacy First.'
  },
  {
    ...
    keywords: [
      'safeguarding', 'learning disability', 'learning difficulties', 'autism',
      'severe mental illness', 'schizophrenia', 'bipolar', 'section',
      'vulnerable adult', 'child protection', 'at risk'
    ],
    action: 'Forward to Tier 2 with HIGH RISK flag. Do NOT use self-care or Pharmacy First.'
  },
  {
    ...
    keywords: [
      'baby', 'infant', 'newborn', 'weeks old', 'months old baby',
      'under 1 year', 'neonate', 'my baby'
    ],
    action: 'Forward to Tier 2 with HIGH RISK flag. Do NOT use self-care or Pharmacy First.'
  },
  {
    group: 'Child under 5 years with NEW symptom',
    keywords: [
      'toddler', 'child under 5', '2 year old', '3 year old', '4 year old',
      'preschool', 'nursery age', 'little one', 'my toddler', 'young child'
    ],
    action: 'Forward to Tier 2 with HIGH RISK flag. Do NOT use self-care or Pharmacy First.'
  },
  {
    ...
    keywords: [
      'cancer treatment', 'on chemo', 'having radiotherapy', 'cancer patient',
      'oncology', 'tumour', 'malignant', 'active cancer', 'cancer drugs'
    ],
    action: 'Forward to Tier 2 with HIGH RISK flag. Do NOT use self-care or Pharmacy First.'
  },
  {
    ...
    keywords: [
      'spinal cord injury', 'spinal injury', 'paralysed', 'paraplegic',
      'quadriplegic', 'tetraplegic', 'wheelchair spinal', 'spinal patient'
    ],
    action: 'Forward to Tier 2 with HIGH RISK flag. Do NOT use self-care or Pharmacy First.'
  },
  {
    ...
    keywords: [
      'recent surgery', 'just had operation', 'post-op', 'after surgery',
      'discharged from hospital', 'recently in hospital', 'just out of hospital',
      'had an operation', 'post-operative', 'surgical wound'
    ],
    action: 'Forward to Tier 2 with HIGH RISK flag. Do NOT use self-care or Pharmacy First.'
  },
  {
    ...
    keywords: [
      'interpreter', 'translator', 'doesn\'t speak english', 'no english',
      'language barrier', 'can\'t understand', 'communication difficulty',
      'deaf', 'hearing impaired', 'non-verbal', 'speech difficulty'
    ],
    action: 'Forward to Tier 2 with HIGH RISK flag. Do NOT use self-care or Pharmacy First.'
  },
  {
    ...
    keywords: [
      'homeless', 'rough sleeper', 'no fixed abode', 'NFA', 'sleeping rough',
      'no address', 'sofa surfing', 'hostel', 'temporary accommodation',
  ...
  },
  {
    ...
    keywords: [
      'substance misuse', 'drug user', 'alcohol dependent', 'alcoholic',
      'drug problem', 'addiction', 'heroin', 'methadone', 'drinking problem',
      'substance abuse', 'drug addiction', 'alcohol misuse'
    ],
    action: 'Forward to Tier 2 with HIGH RISK flag. Do NOT use self-care or Pharmacy First.'
  }
];

// 8 NHS England Pharmacy First pathways — matching SOP Section 7.
// Schema: { id: string, condition: string, ageRange: string, keywords: string[], exclusions: string[] }
export const pharmacyFirstConditions = [
  {
    ...
    ageRange: 'Age 5+',
    keywords: [
      'sore throat', 'throat pain', 'hurts to swallow', 'painful throat',
      'throat infection', 'tonsils', 'swollen tonsils', 'scratchy throat',
      'raw throat', 'throat really sore'
    ],
    exclusions: [
      'Immunosuppressed',
      'Very unwell / high fever',
      'Can\'t swallow fluids',
      'Peritonsillar abscess signs (can\'t open mouth, drooling, muffled voice)',
  ...
  },
  {
    ...
    ageRange: 'Age 1-17',
    keywords: [
      'earache', 'ear pain', 'sore ear', 'ear hurts', 'ear infection',
      'child ear pain', 'pulling at ear', 'ear throbbing', 'ear really sore'
    ],
    exclusions: [
      'Discharge from ear',
      'Very unwell / high fever',
      'Behind-ear swelling or redness (mastoid)',
      'Immunosuppressed',
  ...
  },
  {
    ...
    ageRange: 'Age 12+',
    keywords: [
      'sinusitis', 'sinus pain', 'blocked nose', 'face pain', 'sinus infection',
      'pressure in face', 'pain around eyes nose', 'bunged up', 'congested face pain',
      'sinus headache'
    ],
    exclusions: [
      ...
      'Visual changes',
      'Symptoms >12 weeks (chronic sinusitis)'
    ]
  },
  {
    id: 'insect-bite',
    ...
    ageRange: 'Age 1+',
    keywords: [
      'insect bite', 'bug bite', 'infected bite', 'bite gone red',
      'bite swollen', 'mosquito bite infected', 'tick bite', 'bite infected',
      'bite red and hot', 'bite weeping'
    ],
    exclusions: [
      'Rapidly spreading redness',
      'Very unwell / fever / rigors',
      'Facial bite with significant swelling',
      'Immunosuppressed',
      'Near eye'
    ]
  },
  {
    ...
    ageRange: 'Age 1+',
    keywords: [
      'impetigo', 'crusty sore', 'weepy sore', 'golden crust', 'yellow crust skin',
      'sore won\'t heal child', 'blistery rash child', 'honey-coloured crust',
      'school sores', 'crusty patch skin'
    ],
    exclusions: [
      'Widespread (multiple large areas)',
      'Very unwell / fever',
      'Near eyes',
      'Immunosuppressed',
      'Bullous impetigo (large fluid-filled blisters)',
      'Not responding to previous treatment'
    ]
  },
  {
    id: 'shingles',
    ...
    ageRange: 'Age 18+',
    keywords: [
      'shingles', 'rash one side', 'burning rash', 'blistery rash one side',
      'nerve pain rash', 'painful rash band', 'shingles rash', 'herpes zoster',
      'rash on one side body', 'tingling then rash'
    ],
    exclusions: [
      'Facial or eye involvement (forehead, nose tip, eye area)',
      'Immunosuppressed',
      'Very unwell / widespread',
      'Rash onset >72 hours ago (antivirals less effective)',
      'Pregnant'
    ]
  },
  {
    ...
    ageRange: 'Women 16-64',
    keywords: [
      'uti', 'burning wee', 'painful urination', 'urinary infection',
      'cystitis', 'stinging when I pee', 'peeing a lot', 'water infection',
      'need to wee all the time', 'burning pee', 'wee hurts'
    ],
    exclusions: [
      'Pregnant',
      'Male',
      'Catheter in situ',
      'Kidney/flank/back pain',
  ...
  },
  {
    ...
    ageRange: 'Age 1-17',
    keywords: [
      'ear infection child', 'middle ear infection', 'otitis media',
      'child ear infection', 'baby ear infection', 'toddler ear pain',
      'ear drum pain', 'ear infection toddler', 'child ear really sore'
    ],
    exclusions: [
      'Ear discharge',
      'Behind-ear swelling or redness (mastoid)',
      ...
      'Immunosuppressed',
      'Under 1 year old',
      'Recurrent ear infections (4+ in 12 months)'
    ]
  }
];
