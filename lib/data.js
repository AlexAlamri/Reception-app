...
// ALWAYS go to Tier 3 GP Triager. Tier 2 CANNOT book these.
export const purpleFlags = [
  {
    ...
    triggers: [
      ...
      'bowel change >6wks', 'swallowing difficulty', 'PMB', 'hoarseness >3wks',
      'night sweats', 'persistent cough >3wks', 'mole changes', 'unexplained fatigue',
      'iron deficiency anaemia', 'persistent bloating (women >50)', 'nipple changes',
      'lymphadenopathy >3wks', 'persistent bone pain'
    ],
    keywords: [
  ...
  },
  {
    ...
    triggers: [
      'any new symptom or parental concern in infant under 1'
    ],
    keywords: [
      'baby', 'infant', 'newborn', 'weeks old', 'months old', 'under 1'
    ],
  ...
  },
  {
    ...
    triggers: [
      'any patient in high-risk group with NEW symptoms not covered by existing plan'
    ],
    keywords: [
      'high risk', 'immunosuppressed', 'transplant', 'cancer patient', 'no spleen',
      'pregnant', 'frail'
    ],
  ...
  },
  {
    ...
    keywords: [
      'medication', 'dose', 'side effect', 'prescription', 'tablets',
      'medicine change', 'drug interaction', 'ran out'
    ],
...
export const yellowFlags = [
  ...
  },
  {
    ...
    keywords: [
      'low mood', 'depressed', 'anxiety', 'anxious', 'stressed',
      "can't cope", 'mental health', 'panic attacks'
    ],
...
export const stopPatterns = [
  {
    ...
    keywords: [
      'chest pain', 'chest tight', 'tight chest', 'crushing', 'heavy chest',
      'squeezing', 'pressure in chest', 'elephant on chest', 'band around chest'
    ],
    system: 'Cardiac'
  },
  {
    ...
    keywords: [
      "can't breathe", 'cant breathe', 'struggling to breathe',
      "can't speak", 'blue lips', 'grey lips'
    ],
    system: 'Respiratory'
  },
  {
    ...
    keywords: [
      'face droop', 'face dropped', 'arm weak', 'arm numb',
      'slurred speech', "can't talk properly"
    ],
    system: 'Stroke'
  },
  {
    ...
    keywords: [
      'collapsed', 'unconscious', 'fitting', 'seizure',
      "won't wake up", 'passed out', 'not responsive'
    ],
    system: 'Neurological'
  },
  {
    ...
    keywords: [
      'worst headache', 'thunderclap', 'worst head pain',
      'never had headache like'
    ],
    system: 'Neurological'
  },
  {
    ...
    keywords: [
      'vomiting blood', 'blood in vomit', 'black stools',
      'tarry stools', 'melaena', 'coffee ground vomit'
    ],
    system: 'GI'
  },
  {
    ...
    keywords: [
      "bleeding won't stop", 'heavy bleeding', 'soaking through',
      "can't stop bleeding"
    ],
    system: 'Haemorrhage'
  },
  ...
  },
  {
    ...
    keywords: [
      'testicular pain', 'testicle pain', 'ball pain'
    ],
    system: 'Urological'
  },
  {
    ...
    keywords: [
      'pregnant pain', 'pregnancy pain', 'shoulder tip pain',
  ...
  },
  {
    ...
    keywords: [
      'non-blanching rash', "rash won't fade", "rash doesn't fade",
  ...
  },
  {
    ...
    keywords: [
      'chemical eye', 'chemical splash', 'bleach in eye', 'acid in eye'
    ],
    system: 'Eye'
  },
  {
    ...
    keywords: [
      'tongue swelling', 'throat closing', 'face swelling',
      'throat swollen', 'anaphylaxis', 'allergic reaction'
    ],
    system: 'Allergy'
  },
  {
    ...
    keywords: [
      'taken something', 'overdose', 'hurting myself',
      'killing myself now', 'just taken', 'swallowed pills'
    ],
    system: 'Mental Health'
  },
  {
    ...
    keywords: [
      'saddle numbness', "can't feel between legs", 'lost bladder control',
      'lost bowel control', 'cauda equina'
    ],
    system: 'Neurological'
  },
  {
    ...
    keywords: [
      'leg cold', 'leg white', 'leg pale', 'no pulse in leg', 'foot cold'
    ],
    system: 'Vascular'
  },
  {
    ...
    keywords: [
      'cancer back pain', 'cancer leg weakness', 'cancer spine'
    ],
    system: 'Oncology'
  }
];
