...
// eConsult hard stops - requests that must NOT go via eConsult/remote pathway
export const eConsultExclusions = [
  { id: 'red-flags', label: 'Any RED flag words present (not yet clinically reviewed)', color: 'red' },
  { id: 'amber-same-day', label: 'Any AMBER flags needing same-day review', color: 'red' },
  { id: 'unwell-high-risk', label: 'UNWELL high-risk/vulnerable patient', color: 'red' },
  { id: 'multiple-problems', label: 'Multiple problems or "severe/worsening/worst ever"', color: 'amber' },
  { id: 'over-2-weeks', label: 'Symptoms >2 weeks and not improving', color: 'amber' },
  { id: 'post-op', label: 'Post-operative concerns <6 weeks (DVT/PE/infection risk)', color: 'red' },
  { id: 'suspected-dvt-pe', label: 'Suspected DVT or PE (urgent Wells score needed)', color: 'red' },
  { id: 'child-under-1', label: 'Any child under 1 year', color: 'red' },
  { id: 'suspected-fracture', label: 'Suspected fracture or acute trauma', color: 'amber' },
  { id: 'new-neuro', label: 'New neurological symptoms (weakness, numbness, speech changes)', color: 'red' }
];
